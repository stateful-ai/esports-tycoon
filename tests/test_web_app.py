...
class TestWebApp(unittest.TestCase):
    ...
    def test_week10_ops_room_art_is_served(self):
        ...
        week11_cinematic_arena_resp = self.client.get("/static/art/week11-match-arena-cinematic.webp")
        self.assertEqual(week11_cinematic_arena_resp.status_code, 200)
        self.assertEqual(week11_cinematic_arena_resp.mimetype, "image/webp")
        self.assertTrue(week11_cinematic_arena_resp.data.startswith(b"RIFF"))
    ...
    def test_week11_match_viewer_consumes_result_and_writes_replay(self):
        ...
        self.assertIn(b"/static/art/week11-match-arena-cinematic.webp", page.data)
        ...
        self.assertIn(b"scoreboard-strip", page.data)
        self.assertIn(b"score-overcast", page.data)
        self.assertIn(b"score-opponent", page.data)
        self.assertIn(b"win-probability", page.data)
        self.assertIn(b"renderScoreboard", page.data)
        self.assertIn(b"telemetry-space-control", page.data)
        self.assertIn(b"/static/art/portraits/overcast-lineup.webp", page.data)
        self.assertIn(b"/static/art/opponents/apex-foundry-lineup.webp", page.data)
        self.assertIn(b"Matchup art", page.data)
        self.assertIn(b"Apex Foundry rival lineup", page.data)
        ...
        self.assertIn(b"cinematic-letterbox", page.data)
        self.assertIn(b"camera-frame", page.data)
        self.assertIn(b"camera-rec", page.data)
        self.assertIn(b"director-lower-third", page.data)
        self.assertIn(b"director-headline", page.data)
        self.assertIn(b"renderDirectorOverlay", page.data)
        self.assertIn(b"impact-hot", page.data)
        self.assertIn(b"impact-negative", page.data)
        self.assertIn(b"arenaImpact", page.data)
        self.assertIn(b"renderCinematicState", page.data)
        self.assertIn(b"prefers-reduced-motion", page.data)
        self.assertIn(b"timeline-filmstrip", page.data)
        self.assertIn(b"Replay timeline", page.data)
        self.assertIn(b"tick-spark", page.data)
        self.assertIn(b"tick-phase", page.data)
        self.assertIn(b"marker-nameplate", page.data)
        self.assertIn(b"marker-health-ring", page.data)
        self.assertIn(b"renderMarkerChrome", page.data)
        ...
        self.assertIn(b"affordance-layer", page.data)
        self.assertIn(b"affordance-route", page.data)
        ...
        self.assertIn(b"info-confidence", page.data)
        self.assertIn(b"info-fog", page.data)
        self.assertIn(b"vision-toggle", page.data)
        self.assertIn(b"policy-vision-toggle", page.data)
        self.assertIn(b"Policy vision", page.data)
        self.assertIn(b"fog-layer", page.data)
        self.assertIn(b"vision-layer", page.data)
        self.assertIn(b"vision-line", page.data)
        self.assertIn(b"fog-marker", page.data)
        self.assertIn(b"renderInformationState", page.data)
        self.assertIn(b"information_state", page.data)
        ...
        self.assertIn(b"objective-strip", page.data)
        self.assertIn(b"objective-status", page.data)
        self.assertIn(b"objective-progress", page.data)
        self.assertIn(b"objective-carrier", page.data)
        self.assertIn(b"renderObjective", page.data)
        self.assertIn(b"loadout-strip", page.data)
        self.assertIn(b"loadout-label", page.data)
        self.assertIn(b"loadout-team-credits", page.data)
        self.assertIn(b"loadout-pressure", page.data)
        self.assertIn(b"renderLoadout", page.data)
        ...
        self.assertIn(b"policy-coach", page.data)
        self.assertIn(b"policy-priors", page.data)
        self.assertIn(b"branch-comparison", page.data)
        self.assertIn(b"selected-branch-route", page.data)
        self.assertIn(b"renderActionMask", page.data)
        self.assertIn(b"renderActionAffordances", page.data)
        self.assertIn(b"renderPolicyCoach", page.data)
        ...
        self.assertIn('"target_x":', replay_json)
        self.assertIn('"target_y":', replay_json)
        self.assertIn('"expected_delta":', replay_json)
        self.assertIn('"risk_delta":', replay_json)
        self.assertIn('"counterfactual_tag":', replay_json)
        self.assertIn('"policy_evaluation":', replay_json)
        self.assertIn('"policy_evaluation_unit": "steps[].policy_evaluation"', replay_json)
        self.assertIn('"top_priors":', replay_json)
        self.assertIn('"exploration_temperature":', replay_json)
        self.assertIn('"trait_alignment":', replay_json)
        ...
        self.assertIn('"objective_state":', replay_json)
        self.assertIn('"objective_state_unit": "frames[].objective_state"', replay_json)
        self.assertIn('"post_plant_seconds":', replay_json)
        self.assertIn('"loadout_state":', replay_json)
        self.assertIn('"loadout_state_unit": "frames[].loadout_state"', replay_json)
        self.assertIn('"economy_pressure":', replay_json)
        self.assertIn('"team_credits":', replay_json)
        self.assertIn('"score_state":', replay_json)
        self.assertIn('"score_state_unit": "frames[].score_state"', replay_json)
        self.assertIn('"win_probability":', replay_json)
        self.assertIn('"man_advantage":', replay_json)
        self.assertIn('"information_state":', replay_json)
        self.assertIn('"information_state_unit": "frames[].information_state"', replay_json)
        self.assertIn('"contact_confidence":', replay_json)
        self.assertIn('"fog_pressure":', replay_json)
        self.assertIn('"sightlines":', replay_json)
    ...
    def test_week11_training_dataset_consumes_development_plan_and_writes_artifact(self):
        ...
        self.assertIn(b"policy_targets", page.data)
        self.assertIn(b"episodes", page.data)
        self.assertIn(b"eval", page.data)
        ...
        self.assertIn('"episodes":', dataset_json)
        self.assertIn('"episode_format": "round_bounded_episode_v1"', dataset_json)
        self.assertIn('"episode_step":', dataset_json)
        self.assertIn('"next_sample_id":', dataset_json)
        self.assertIn('"split_counts":', dataset_json)
    ...
    def test_week12_model_prep_consumes_training_dataset_and_writes_artifact(self):
        ...
        self.assertIn(b"train", page.data)
        self.assertIn(b"eval", page.data)
        ...
        self.assertIn('"train_sample_count":', prep_json)
        self.assertIn('"eval_sample_count":', prep_json)
        self.assertIn('"eval_reward_mean_x100":', prep_json)
        self.assertIn('"evaluation_gate_basis":', prep_json)
